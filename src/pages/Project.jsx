...
export default function Project() {
  ...
  return <article className="project-page">
    <div className="project-hero"><img src={project.image} alt={project.alt} width={project.width} height={project.height} fetchPriority="high" /><div className="project-hero-title"><span>{project.category} · {project.year}</span><h1>{project.title}</h1></div></div>
