...
export default function Project() {
  ...
  return <article className="project-page">
    ...
    <div className="gallery-grid"><img src={project.image} alt={`${project.title} overall view`} loading="lazy" /><div className="diagram-placeholder"><span>Drawing / diagram placeholder</span><small>Replace with project-specific content</small></div><img src={project.image} alt={`${project.title} detail view placeholder`} loading="lazy" /></div>
    {project.recognition.length > 0 && <section className="project-recognition"><span className="eyebrow">Recognition</span>{project.recognition.map(r => <p key={r}>{r}</p>)}</section>}
