...
export default function Home() {
  return <>
    <section className="hero">
      <img src="/images/steps-of-tranquility.webp" alt="Steps of Tranquility, a terraced cultural platform" />
      <div className="hero-shade" />
      <div className="hero-title"><p>Architectural Designer · Computational Designer</p><h1>Shuai Zhang</h1><span>Architecture, computation and artificial intelligence</span></div>
      <div className="hero-index"><span>Featured project</span><span>Steps of Tranquility<br />Burnaby · 2025</span></div>
    ...
    <section className="dark-section">
      ...
      <div className="recognition-list">{awards.slice(0, 5).map((item) => <div className="recognition-row" key={item.title}><span>{item.year}</span><strong>{item.title}</strong><span>{item.detail}</span></div>)}</div>
